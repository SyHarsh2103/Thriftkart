...
const AddSideBanner = () => {
  ...
  // Helper: get parent category id from subCat with multiple possible shapes
  ...
  // Only show subcats of selected category
  ...
  const handleCategoryChange = (e) => {
    ...
    setSubCatVal(""); // reset subCat when category changes
  };
